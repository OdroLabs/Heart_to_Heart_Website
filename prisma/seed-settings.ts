...
const content: Record<string, Val> = {
  ...
  about_history_timeline: {
    en: "2002 :: Founded in Kolonnawa\n2010 :: Expanded to 5 districts\n2022 :: Celebrating 20 years of impact",
    si: "2002 :: කොළොන්නාවේ ආරම්භ කරන ලදී\n2010 :: දිස්ත්‍රික්ක 5ක් දක්වා ව්‍යාප්ත විය\n2022 :: වසර 20ක බලපෑම සමරමින්",
  ...
  about_founder_image: { en: "https://images.unsplash.com/photo-1560250097-0b93528c311a?auto=format&fit=crop&w=800&q=80" },
